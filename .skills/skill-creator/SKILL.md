...
**Why:** `agents/skills/` is visible in Finder (no dot prefix), serves as single source of truth, and symlinks wire it up for both Claude Code (`.claude/skills/`) and Codex CLI (`.codex/skills/`). Edit in `agents/skills/` — changes reflect everywhere.
